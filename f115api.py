...
def getTasksign(mySession): # 获取登陆后的sign
    global tsign,ttime
    url = 'http://115.com/'
    params = {
        'ct':'offline',
...
def addLinktask(mySession,link):
...
def get_bt_upload_info(mySession):
...
def upload_torrent(mySession, filename,filedir):
